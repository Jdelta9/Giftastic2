...
var topics = ["Superman", "Wonder Woman", "The Flash", "Spiderman", "Antman", "The Hulk", "Captain America",
    "Aquaman", "Harley Quinn", "Lex Luthor", "deadpool", "Wolverine"];
var responseCopy;
var gifToggle = false;
...
function displayGifyInfo() {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?api_key=HIfJKXEPkOb2EzAX2ALJrGuCkpXyw8PU=" + gif + "&limit=10&rating=pg";
